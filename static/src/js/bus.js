odoo.define('lod_kokkokm.bus', function (require) {
    "use strict";
    ...
    bus.Bus = Widget.extend({
        ...
        start_polling: function () {
            console.log("Start Polling=====",this)
            if (!this.activated) {
                this.poll();
                this.stop = false;
            }
        ...
        poll: function () {
            ...
            session.rpc('/longpolling/poll', data, {shadow: true, timeout: 60000}).then(function (result) {
                console.log("Long Polling---",result,self)
        ...
        on_notification: function (notifications) {
            console.log("On Notification----",notifications)
            var self = this;
    ...
    var CrossTabBus = bus.Bus.extend({
        ...
        on_notification: function (notifications) {
            console.log("Callllllllled===========CrossTab",this,notifications)
